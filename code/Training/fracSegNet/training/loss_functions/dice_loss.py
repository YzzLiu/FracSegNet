...
class SoftDiceLoss(nn.Module):
    ...
    def forward(self, x, y,disMap = None, loss_mask=None,current_epoch= None):
        ...
        # print("tp = ", tp)
        # print("np.shape(fp) = ", np.shape(fp))
        # print("np.shape(fn) = ", np.shape(fn))
...
class DC_and_CE_loss(nn.Module):
    def __init__(self, soft_dice_kwargs, ce_kwargs, disMap_weight=None,epoch = None, aggregate="sum", square_dice=False, weight_ce=1,
                 weight_dice=1,
